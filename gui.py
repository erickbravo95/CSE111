...
def populate_main_window(frm_main):
    ...
    lbl_formula = Label(frm_main, text="a = π")
    ...
    lbl_potent = Label(frm_main, text="2")

    # Create a label that displays "Rates:"
    lbl_total = Label(frm_main, text="a =")
    ...
    lbl_formula.grid(      row=1, column=0, padx=3, pady=3)
    ent_radius.grid(      row=1, column=1, padx=3, pady=3)
    lbl_potent.grid(    row=0, column=2, padx=0, pady=3)

    lbl_total.grid(     row=2, column=0, padx=(30,3), pady=3)
